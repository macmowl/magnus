            ...
            <div class="col-12">
                <div class="row justify-content-center no-gutters">
                    <div class="col-lg-5 col-md-5 col-12">
                        <div class="p-30 rounded30 box box-default">
                            <div class="box-body">
                            ...
                            <form action="{{ route('register') }}" method="post" class="box-body">
                                @csrf
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="name" value="{{ old('name') }}" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Full Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="email" name="email" value="{{ old('email') }}" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Email">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password" class="form-control pl-15 bg-transparent text-white plc-white" name="password_confirmation" placeholder="Retype Password">
                                    </div>
                                </div>
                                  <div class="row">
                                    <div class="col-12">
